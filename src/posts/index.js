...
if (localStorage.getItem("socketUrl") === null) {
  localStorage.setItem("socketUrl", "ws://35.231.87.178:8091");
} else if (localStorage.getItem("socketUrl") == "ws://35.231.87.178:8091") {
  localStorage.socketUrl="ws://35.231.87.178:8091";
} else if (localStorage.getItem("socketUrl") == "ws://35.231.87.178:8091" || localStorage.getItem("socketUrl") == "https://scorumd.scorumit.com") {
  localStorage.socketUrl="ws://35.231.87.178:8091";
}
